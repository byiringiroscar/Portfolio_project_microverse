...
**Oscar portfolio** is Project developed during day 3 in microverse which have my personal introduction and link for my social media all 
...
```sh
  git clone https://github.com/byiringiroscar/Portfolio_project_microverse
```
...
Install this project with: cd Portfolio_project_microverse

```sh
  cd Portfolio_project_microverse
```
